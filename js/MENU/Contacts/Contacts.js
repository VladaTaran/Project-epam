function Contacts () {
    ...
    contacts.addEventListener('click', isShowContacts);
    
    this.contactsPageElements = function() {
        ...
        const inputMessageLabel = tagCreator('label', contactsForm, 'class',  'contacts-input-label', 'for', 'input-message');
        inputMessageLabel.innerHTML = 'Your Message';
        const inputMessage = tagCreator('textarea', contactsForm, 'class', 'contacts-input', 'id', 'input-message');
...
contactUsPage.contactsPageElements();